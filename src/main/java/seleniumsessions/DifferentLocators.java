...
public class DifferentLocators {
    ...
    public static void main(String[] args) {
        ...
        //driver.findElement(By.id("selenium")).sendKeys("sahil@gmail.com");
        ...
        //ele2 -- sahil
        //ele3 -- sahil
        //driver.findElement(By.name("sahil")).sendKeys("sahil@gmail.com");
...
//		driver.findElement(By.xpath("//*[@id=\"input-firstname\"]")).sendKeys("Sahil");
...
//
//		doSendKeys(fn_xpath, "SahilTesting");
...
//		driver.findElement(By.cssSelector("#input-firstname")).sendKeys("sahil@gmail.com");
